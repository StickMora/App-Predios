...
class Propietario(models.Model):
    ...
    tipo_propietario = models.CharField(max_length=10, choices=[('Natural', 'Natural'), ('Jurídico', 'Jurídico')])
...
class Predio(models.Model):
    ...
    tipo_predio = models.CharField(max_length=10, choices=TIPO_CHOICES)
